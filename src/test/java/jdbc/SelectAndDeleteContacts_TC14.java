...
public class SelectAndDeleteContacts_TC14 {

	@Test
	public void selectContactAndDeleteTest() throws Throwable {
		...
		if (driver.getCurrentUrl().equals(URL)) {
			System.out.println("URL is correct and Login Page Displayed");
		} else {
			System.out.println("URL is not correct and Login Page not Displayed");
		}
